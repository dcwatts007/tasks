...
function addNumbers()
{
    ...
    let number2=parseInt(document.getElementById(".addend1").value);
    document.getElementById(".sum").innerHTML = add(number1,number2);
}
...
const subtractNumbers = function()
{
    ...
    document.getElementById(".difference").innerHTML = subtract(number1,number2);
}
...
const mulitplyNumbers = ()=>
{
    ...
    document.getElementById(".product").innerHTML = subtract(number1,number2);
}
const mulbuttonElement = document.getElementById(".multiplyNumbers");
mulbuttonElement.addEventListener("click",mulitplyNumbers());
...
const divideNumbers = ()=>
{
    ...
    document.getElementById(".quotient").innerHTML = divide(number1,number2);
}
